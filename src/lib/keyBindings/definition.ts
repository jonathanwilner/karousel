function getKeyBindings(world: World, actions: Actions): KeyBinding[] {
    return [
        ...
        },
        {
            ...
            defaultKeySequence: "Meta+Ctrl+Left",
